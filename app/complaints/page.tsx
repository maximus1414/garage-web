     ...
     <Navbar />
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <p className="text-white/50 mb-8">
          We take every complaint seriously. Our team investigates within 24 hours.
        </p>
        ...
        {submitted ? (
          <div className="bg-[#1db97a]/10 border border-[#1db97a]/30 rounded-2xl p-8 text-center">
            ...
            <div className="bg-white/10 rounded-xl px-6 py-3 font-mono text-xl font-bold text-[#1db97a] mb-6">
              {refNumber}
            </div>
          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-2">
                {COMPLAINT_TYPES.map(type => (
                  <button
                    ...
                    className={`p-3 rounded-xl text-sm text-left transition ${
                      complaintType === type
                        ? 'bg-[#1db97a]/20 border border-[#1db97a] text-[#1db97a]'
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/10 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#1db97a]"
                />
              </div>
            </div>
            ...
            <button
              ...
              disabled={!complaintType || !description || !contactName || !contactPhone}
              className="w-full bg-red-500 text-white py-4 rounded-2xl font-bold hover:bg-red-600 transition disabled:opacity-40 disabled:cursor-not-allowed"
            >
              Submit complaint
            </button>
          </div>
