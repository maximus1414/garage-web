      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="flex gap-3 mb-8">
          ...
          <button
            ...
            className="bg-[#1db97a] text-white px-6 py-3 rounded-xl font-bold hover:bg-[#149558] transition disabled:opacity-40"
          >
                ...
                {[
                  ...
                  return (
                    <div key={step.key} className="flex gap-4">
                      ...
                      <div>
                        <p className={`font-medium ${isDone ? 'text-white' : 'text-white/30'}`}>
                          {step.label}
                        </p>
